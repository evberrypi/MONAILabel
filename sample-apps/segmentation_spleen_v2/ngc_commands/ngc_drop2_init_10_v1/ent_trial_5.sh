...
FOLDER_PATH="/workspace/al_code/MONAILabel/sample-apps/segmentation_spleen_v2"
NGC_WORKSPACE="mednet_pretrain:/workspace"
BASE_DIR="/workspace/al_results/ent_transfer_drop2_init_10_v1/trial_5"
JSON_PATH="/workspace/al_code/spleen_json/dataset_10_init_v1.json"
NGC_DATASET=69970
NGC_INSTANCE=dgx1v.16g.1.norm
EXP_NAME="AL_Entropy_Init_10_v1_Trial_5"
BATCH_SIZE=4
VAL_BATCH_SIZE=1
EPOCHS=300
EVAL_NUM=400

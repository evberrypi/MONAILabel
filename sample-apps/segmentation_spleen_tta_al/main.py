...
parser.add_argument('--random_strategy', default=2, type=int)
...
def main():
    ...
    for active_iter in range(args.active_iters):
        ...
        # Random Strategy = 2 implies that TTA is going to be used for Sample Selection
        if args.random_strategy == 2:
